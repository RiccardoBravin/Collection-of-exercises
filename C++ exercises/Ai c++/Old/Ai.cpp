...
double Neuron::eta = 0.4;  //0.15  // overall net learning rate, [0.0..1.0]
...
Net::Net(const vector<unsigned> &topology)
{
    ...
    for (unsigned layerNum = 0; layerNum < numLayers; ++layerNum) {
        ...
        cout << "Made layer number " << layerNum << " of size " << m_layers.back().size() << endl;
...
int main()
{
    TrainingData trainData("data_creator/training_data.txt");
